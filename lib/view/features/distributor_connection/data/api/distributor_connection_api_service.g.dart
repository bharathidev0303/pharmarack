...
part of 'distributor_connection_api_service.dart';
...
class _DistributorConnectionApiService
    implements DistributorConnectionApiService {
  ...
  Future<DistributorStoreResponseModel> getNonmappedStoreStatus({
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<DistributorStoreResponseModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = DistributorStoreResponseModel.fromJson(_result.data!);
    return value;
  }
  ...
  Future<SaveRetailerStoreResponse> saveRetailerStoreRequest(
    ...
    _data.addAll(request);
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<SaveRetailerStoreResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = SaveRetailerStoreResponse.fromJson(_result.data!);
    return value;
  }
