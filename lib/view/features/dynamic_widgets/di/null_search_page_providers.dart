...
import 'package:pharmarack/view/features/dynamic_widgets/presentation/cubit/null_search_page/null_search_page_cubit.dart';
import 'package:pharmarack/view/features/dynamic_widgets/presentation/cubit/null_search_page/null_search_page_state.dart';

void initNullSearchPageDi() {
  ...
  // Register Cubits
  getIt.unregister<NullSearchPageCubit>();

  getIt.registerSingleton<NullSearchPageCubit>(
    NullSearchPageCubit(
        NullSearchPageState.initial(), getIt<DynamicWidgetsUseCase>()),
  );
}

final nullSearchPageScreenCubit = getIt.isRegistered<NullSearchPageCubit>()
    ? getIt<NullSearchPageCubit>()
    : getIt.registerSingleton(
        NullSearchPageCubit(getIt(), getIt()),
      );

void clearNullSearchPageDi() {
