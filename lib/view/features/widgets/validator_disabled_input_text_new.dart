...
class ValidatorDisabledInputTextNew extends StatefulWidget {
  ...
  const ValidatorDisabledInputTextNew({
    super.key,
    this.widgetKey,
  ...
  @override
  State<ValidatorDisabledInputTextNew> createState() =>
      _ValidatorInputTextNewState();
}

class _ValidatorInputTextNewState extends State<ValidatorDisabledInputTextNew> {
  String? _errorText;
