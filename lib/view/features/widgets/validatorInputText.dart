...
class ValidatorInputTextNew extends StatefulWidget {
  ...
  @override
  State<ValidatorInputTextNew> createState() => _ValidatorInputTextNewState();
}

class _ValidatorInputTextNewState extends State<ValidatorInputTextNew> {
  String? _errorText;
