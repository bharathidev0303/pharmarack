...
class FiltersPageMobileView extends StatefulWidget {
  ...
  const FiltersPageMobileView(
      {super.key, required this.callBack, required this.searchProductCubit});
...
class FiltersPageMobileViewState extends State<FiltersPageMobileView> {
  ...
  void initState() {
    super.initState();
    widget.searchProductCubit.addInitialData();
  }
                      ...
                      children: [
                        _buildFiltersSelectionView(
                          ...
                          SearchByProductFilter(
                              filterName:
                                  context.localizedString.stockAndPriority,
                              value: 1,
                              requestKey: FilterType.BothStockAndPriority,
                              groupKey: FilterType.searchBy),
                          SearchByProductFilter(
                              filterName: context.localizedString.priority,
                              value: 2,
                        ...
                        _buildFiltersSelectionView(
                          ...
                          SearchByProductFilter(
                              filterName: context
                                  .localizedString.includeOutOfStockProducts,
                              value: 3,
                              requestKey: FilterType.IncludeOutOfStockProducts,
                              groupKey: FilterType.stock),
                          SearchByProductFilter(
                              filterName: context.localizedString.onlyInStock,
                              value: 4,
                        ...
                        _buildFiltersSelectionView(
                          ...
                          SearchByProductFilter(
                              filterName:
                                  context.localizedString.scheme_products_only,
                              value: 6,
                        ...
                        _buildFiltersSelectionView(
                          ...
                          SearchByProductFilter(
                              filterName: context.localizedString.expiryHidden,
                              value: 8,
                              requestKey: FilterType.HiddenExpiry,
                              groupKey: FilterType.expiry),
                          SearchByProductFilter(
                              filterName: context.localizedString.expiryVisible,
                              value: 9,
                        ...
                        children: [
                          Expanded(
                            child: PrimaryRoundedCornerButton(
                              ...
                              onTap: () {
                                setState(() {
                                  widget.searchProductCubit.resetFilters();
                                });
              ...
              child: Column(children: [
                for (var singleFilter in filters)
                  RadioListTile<int>(
                    ...
                    groupValue: widget.searchProductCubit
                            .filtersMap[singleFilter.groupKey!.name]?.value ??
                        1,
                    onChanged: (value) {
                      setState(() {
                        widget.searchProductCubit.addFilter(singleFilter,
  ...
  Widget showDistributorList() {
    List<SearchByProductFilter> companyFiltersList = widget
        .searchProductCubit.distributors
              ...
              child: Column(children: [
                for (int i = 0; i < companyFilters.length; i++)
                  CheckboxListTile(
                    ...
                    onChanged: (value) {
                      widget.searchProductCubit.addCheckBoxFilter(
