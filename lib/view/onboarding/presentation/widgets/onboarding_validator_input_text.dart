...
class OnboardingValidatorInputTextNew extends StatefulWidget {
  ...
  State<OnboardingValidatorInputTextNew> createState() =>
      _OnboardingValidatorInputTextNewState();
}

class _OnboardingValidatorInputTextNewState
    extends State<OnboardingValidatorInputTextNew> {
  String? _errorText;
