...
part of 'fulfilment_partner_api_service.dart';
...
class _FulfilmentPartnerApiService implements FulfilmentPartnerApiService {
  _FulfilmentPartnerApiService(
    this._dio, {
    this.baseUrl,
  });
  ...
  @override
  Future<HttpResponse<String>> getMappedSettingsRequest() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<HttpResponse<String>> saveFulfillmentPartnerSettings(
      String query) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'dataforController': query};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result =
        await _dio.fetch<String>(_setStreamType<HttpResponse<String>>(Options(
