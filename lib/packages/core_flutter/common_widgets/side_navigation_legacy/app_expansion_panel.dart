...
class AppExpansionPanelList extends StatefulWidget {
  /// Creates an expansion panel list widgets. The [expansionCallback] is
  ...
  /// AppExpansionPanelList.radio is simply meant to inform the parent widgets of
  /// changes, as the radio panels' open/close states are managed internally.
  ///
  /// This callback is useful in order to keep track of the expanded/collapsed
  /// panels in a parent widgets that may need to react to these changes.
...
class _AppExpansionPanelListState extends State<AppExpansionPanelList> {
  ...
  void didUpdateWidget(AppExpansionPanelList oldWidget) {
    ...
    if (widget._allowOnlyOnePanelOpen) {
      assert(_allIdentifiersUnique(),
          'All ExpansionPanelRadio identifier values must be unique.');
      // If the previous widgets was non-radio AppExpansionPanelList, initialize the
      // open panel to widgets.initialOpenPanelValue
  ...
  Widget build(BuildContext context) {
    ...
    for (int index = 0; index < widget.children.length; index += 1) {
      //Uncomment to add gap between selected panels
...
class AppExpansionPanel {
  ...
  /// See [ExpansionPanelList] for an example on how to use this widgets.
  ///
  ...
  /// The widgets builder that builds the expansion panels' header.
  final ExpansionPanelHeaderBuilder headerBuilder;

  /// The widgets builder that builds the expansion panels' icon.
  ///
  ...
  ///
  /// This widgets is visible only when the panel is expanded.
  final Widget body;
