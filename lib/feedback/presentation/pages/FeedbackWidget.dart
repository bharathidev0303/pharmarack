...
class _FeedbackFormState extends State<FeedBackWidget> {
  ...
  //var FeedbackTypeList = GetIt.instance<FeedbackScreenCubit>().getFeedbackTypeList();

  final feedbackCubit = GetIt.instance<FeedbackScreenCubit>();
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: DropdownButton<String>(
                          ...
                          items: feedbackOptions.map<DropdownMenuItem<String>>(
                          ...
                          ? TextField(
                              ...
                              decoration: const InputDecoration(
                                ...
                                hintStyle: TextStyle(
                                    ...
                                    fontSize: 14.0,
                                    fontWeight:
                                        FontWeight.w500), // Set the hint color
                                filled: true,
