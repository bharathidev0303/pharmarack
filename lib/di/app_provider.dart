...
import 'package:pharmarack/packages/splash_screen/data/data_source/local_data_source/local_data_source.dart';
import 'package:pharmarack/packages/splash_screen/data/data_source/remote_data_source/remote_data_source.dart';
import 'package:pharmarack/packages/splash_screen/data/repository/splash_screen_repository_impl.dart';
...
class AppProviders {
  init(Flavor flavor) async {
    ...
    // getIt.registerLazySingleton<RoutePaths>(() => RoutePaths());
